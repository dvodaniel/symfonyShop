...
class DefaultController extends AbstractController
{
     ...
     */
    public function contactInfo(CategoryRepository $categoryRepository): Response
    {
        return $this->render('default/contactInfo.html.twig', ['categories'=>$categoryRepository->findAll()]);
    }
}
